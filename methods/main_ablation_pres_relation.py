...
_ckpt_stem = f"{data_name}_pres_rel"
print(
    f"[ablation pres_relation] {_rel} pres_mix_uniform={args.pres_mix_uniform} "
    f"-> {paths.model_save_path(_ckpt_stem)}"
)
...
for m in range(1):
    ...
    log_training_result(
        run_type="ablation_pres_relation",
        data_name=data_name,
        ...
        extra={
            ...
            "pres_relation": _rel,
            "exp_name": f"{data_name}_pres_rel",
        },
    )
